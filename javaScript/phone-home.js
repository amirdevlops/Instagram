...
slider.addEventListener("touchmove", (e) => {
  ...
  // Check if it's the last slide and prevent further scroll if needed
  if ((slideIndex === slider.children.length - 1 && deltaX < 0) ||
      (slideIndex === 0 && deltaX > 0)) {
    return;
  }

  slider.style.transform = `translateX(calc(-${slideIndex * 100}% + ${deltaX}px))`;
